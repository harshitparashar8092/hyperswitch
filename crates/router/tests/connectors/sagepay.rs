...
#[derive(Clone, Copy)]
struct SagepayTest;
impl ConnectorActions for SagepayTest {}
impl utils::Connector for SagepayTest {
    fn get_data(&self) -> types::api::ConnectorData {
        use router::connector::Sagepay;
        types::api::ConnectorData {
            connector: Box::new(&Sagepay),
            connector_name: types::Connector::Sagepay,
...
static CONNECTOR: SagepayTest = SagepayTest {};
